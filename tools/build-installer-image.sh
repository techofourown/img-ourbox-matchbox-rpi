...
normalize_baked_airgap_defaults() {
...
export PIGEN_DOCKER_OPTS="${PIGEN_DOCKER_OPTS:-} \
  ...
  -e AIRGAP_PLATFORM_DEFAULT_REF=${AIRGAP_PLATFORM_DEFAULT_REF} \
  ...
  -e AIRGAP_PLATFORM_CHANNEL_STABLE_TAG=${AIRGAP_PLATFORM_CHANNEL_STABLE_TAG} \
  -e AIRGAP_PLATFORM_CHANNEL_BETA_TAG=${AIRGAP_PLATFORM_CHANNEL_BETA_TAG} \
  -e AIRGAP_PLATFORM_CHANNEL_NIGHTLY_TAG=${AIRGAP_PLATFORM_CHANNEL_NIGHTLY_TAG} \
  -e AIRGAP_PLATFORM_CHANNEL_EXP_LABS_TAG=${AIRGAP_PLATFORM_CHANNEL_EXP_LABS_TAG} \
